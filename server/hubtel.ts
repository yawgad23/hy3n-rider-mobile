 ...
 * API ID:  295WvzM
 * API Key: 279782ed8a88420ebb629843cfbedf49
 *
...
const HUBTEL_API_ID = process.env.HUBTEL_API_ID || '295WvzM';
const HUBTEL_API_KEY = process.env.HUBTEL_API_KEY || '279782ed8a88420ebb629843cfbedf49';
